...
- `context` (Object) **required** - Context
  ...
  - `country` (String) **optional** - Reserved; currently unused;
- `options` (Object) **optional**:
  - `mode` (String) **optional** - Can be **identify** or **collect**. Default: **identify**. **identify** mode excludes filters: `start_word`, `duplicate` and `partial`;

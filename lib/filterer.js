...
function filterRenames(concepts, context) {
	var rules = conceptData.getRenameConcepts(context.lang, context.country);
...
function filterValidSuffixes(concepts, context) {
	var sources = conceptData.getValidSuffixes(context.lang);
...
function filterValidPrefixes(concepts, context) {
	var sources = conceptData.getValidPrefixes(context.lang);
...
function filterPartialConcepts(concepts, context, mode) {
	var sources = conceptData.getPartialConcepts(context.lang);
...
function filterKnownConcepts(concepts, context) {
	var sources = conceptData.getKnownConcepts(context.lang);
...
function filterInvalidPrefixs(concepts, context) {
	var sources = conceptData.getInvalidPrefixes(context.lang);
...
function filterInvalidConcepts(concepts, context) {
	var sources = conceptData.getInvalidConcepts(context.lang);
